...
<div id="user-<?php echo $user->ID; ?>" class="author-block">
	...
	<?php } else {	
			echo "<a href='http://britishsteel-induction.co.uk/profile/?uid=".$user_info->ID."'>";
			echo $user_info->display_name;
			echo "</a>";
			echo custom_badgeos_user_achievements_list( array( 'user' => $user_info->ID, 'type' => 'badges', 'limit' => 10 ) ); //MY CODE IMPORTANT
